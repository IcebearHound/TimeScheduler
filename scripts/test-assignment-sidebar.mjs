...
try {
  for (const width of [1440, 390, 320]) {
    ...
    assert.equal(await page.locator('[data-task-lamp="仅名称含实验"], [data-assignment-course="excluded"]').count(), 0, 'A course name alone must not turn an ordinary class into a task')
    ...
    await page.getByLabel('课程', { exact: true }).fill('新课程')
